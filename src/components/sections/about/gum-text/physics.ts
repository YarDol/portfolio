import { FRICTION, GRAVITY, ITERS, SEGMENTS, SLACK } from "./constants";
import type { Pt, Rope, Seg, Sp } from "./types";
...
export function stepRope(rope: Rope, x1: number, y1: number, x2: number, y2: number) {
