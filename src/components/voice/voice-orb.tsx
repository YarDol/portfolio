...
import { OrbIcon } from "@/components/voice/ui/orb-icon";
import { OrbRing } from "@/components/voice/ui/orb-ring";
...
export function VoiceOrb({ state, audioLevel, onClick, size = 96 }: VoiceOrbProps) {
  ...
  return (
    ...
    >
      <OrbRing multiplier={1.9} orbSize={size} audioLevel={audioLevel} audioGain={0.65} state={state} delay={0.2} opacity="border-accent/15" />
      <OrbRing multiplier={1.5} orbSize={size} audioLevel={audioLevel} audioGain={0.5} state={state} delay={0.1} opacity="border-accent/25" />
      <OrbRing multiplier={1.2} orbSize={size} audioLevel={audioLevel} audioGain={0.35} state={state} delay={0} opacity="border-accent/45" />
