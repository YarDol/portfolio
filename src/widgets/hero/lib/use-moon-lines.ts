...
import { ANNS, LINE_DUR, STAGGER } from "../config/annotations";
import { getMoonScreen } from "./get-moon-screen";

export function useMoonLines(
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      material.opacity = Math.min(elapsed / 0.6, 0.32);
